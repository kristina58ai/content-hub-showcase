...
**Публичная веб-демонстрация мультиагентной AI-системы генерации контента — с живым графом агентов в реальном времени. https://content-hub-showcase.vercel.app/**
